    ...
    <section className="flex flex-col gap-12 lg:flex-row">
      ...
      >
        ...
        <p className="mx-auto text-center text-sm italic md:text-base  ">
          <br />
          Welcome to my homepage! I'm Julia, an artist deeply connected to
          nature and a natural lifestyle. Here, you'll find my creative journey,
          where l'm constantly learning, experimenting, and drawing inspiration
